           ...
           //*   Obtenim els registres del formulari de manteniment
            ...
            if (empty($records)) {
                ...
                echo '<div style="display: flex; justify-content: center; align-items: center; margin: 40px auto; max-width: 600px; text-align: center;">
                    <div>
                        <a target="_blank" href="/wp-content/themes/hello-elementor-child/generar-pdf/" class="btn-descargar-pdf" style="display: inline-block; background-color: #D04840; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; transition: background-color 0.3s; box-shadow: 0 2px 8px rgba(208, 72, 132, 0.3);">
